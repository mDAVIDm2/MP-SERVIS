...
/// Content-Type для части multipart (Dio иначе шлёт application/octet-stream — бэкенд отклонял до правки, но оставляем явно).
...
/// Сжатие: до 1920 по длинной стороне, JPEG 85% (сервер всё равно делает WebP; так быстрее заливка).
