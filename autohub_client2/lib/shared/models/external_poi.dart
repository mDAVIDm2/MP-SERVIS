/// Внешняя организация (из OSM/Яндекс и т.п.): нет карточки в приложении, не партнёр. На карте — красная метка.
class ExternalPOI {
  final String id;
  final String name;
  final double lat;
  final double lng;
  /// Категории для фильтра: 'Автосервис', 'Мойка', 'Детейлинг', 'Шиномонтаж', 'Кузовной', 'Электрика', 'Диагностика'
