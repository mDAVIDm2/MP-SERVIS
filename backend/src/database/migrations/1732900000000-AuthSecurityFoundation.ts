...
export class AuthSecurityFoundation1732900000000 implements MigrationInterface {
  name = 'AuthSecurityFoundation1732900000000';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    `);
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "IDX_auth_otp_phone_created" ON "auth_otp_challenges" ("phone_digits", "created_at")`,
    );
