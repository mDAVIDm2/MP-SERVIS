...
export class OrganizationInvitations1733100000000 implements MigrationInterface {
  name = 'OrganizationInvitations1733100000000';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "IDX_org_invites_pending_email" ON "organization_invitations" ("organization_id", "invited_email_norm", "status")`,
    );
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS "IDX_org_invites_pending_phone" ON "organization_invitations" ("organization_id", "invited_phone_norm", "status")`,
    );
  }
