...
export class ChatAttachmentsAndMediaChatId1732600000000 implements MigrationInterface {
  name = 'ChatAttachmentsAndMediaChatId1732600000000';
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    // organization_id остаётся nullable; вернуть NOT NULL вручную после очистки NULL.
  }
}
