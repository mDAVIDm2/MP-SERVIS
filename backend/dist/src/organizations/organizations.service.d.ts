...
export declare class OrganizationsService {
    ...
    createInvitation(orgId: string, invitedByUserId: string, dto: {
        name?: string;
        phone?: string;
        email?: string;
        role: string;
    ...
    listInvitations(orgId: string, status?: OrganizationInvitationStatus): Promise<{
        items: {
            id: string;
            organization_id: string;
            invited_by_user_id: string;
    ...
    updateStaffMember(orgId: string, staffId: string, dto: Record<string, unknown>): Promise<{
        id: string;
        user_id: any;
        name: string;
        phone: string | null;
