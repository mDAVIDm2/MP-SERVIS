...
__decorate([
    (0, typeorm_1.Column)({ name: 'organization_id', unique: true }),
    __metadata("design:type", String)
], OrganizationSettings.prototype, "organizationId", void 0);
__decorate([
    (0, typeorm_1.OneToOne)(() => organization_entity_1.Organization, (o) => o.settings, { onDelete: 'CASCADE' }),
...
], OrganizationSettings.prototype, "data", void 0);
