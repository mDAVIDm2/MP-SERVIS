...
exports.ChatsModule = ChatsModule = __decorate([
    (0, common_1.Module)({
        imports: [
            typeorm_1.TypeOrmModule.forFeature([chat_entity_1.Chat, chat_message_entity_1.ChatMessage, chat_message_attachment_entity_1.ChatMessageAttachment, order_entity_1.Order, order_item_entity_1.OrderItem, organization_entity_1.Organization]),
