...
exports.EmailOtpRecipientAndNullablePhone1733000000000 = void 0;
class EmailOtpRecipientAndNullablePhone1733000000000 {
    constructor() {
        this.name = 'EmailOtpRecipientAndNullablePhone1733000000000';
    }
    ...
    `);
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX IF NOT EXISTS "UQ_users_phone_nonnull" ON "users" ("phone") WHERE "phone" IS NOT NULL AND TRIM("phone") <> ''`);
        await queryRunner.query(`
    ...
    `);
        ...
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_otp_recipient_created" ON "auth_otp_challenges" ("recipient", "recipient_kind", "created_at")`);
    }
...
exports.EmailOtpRecipientAndNullablePhone1733000000000 = EmailOtpRecipientAndNullablePhone1733000000000;
//# sourceMappingURL=1733000000000-EmailOtpRecipientAndNullablePhone.js.map